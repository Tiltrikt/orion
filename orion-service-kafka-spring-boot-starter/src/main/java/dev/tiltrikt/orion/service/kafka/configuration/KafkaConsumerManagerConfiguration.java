...
public class KafkaConsumerManagerConfiguration {
    ...
    @NotNull List<String> bootstrapServers;

    @Value("${spring.kafka.consumer.properties.spring.json.trusted.packages}")
    @NotNull String trustedPackages;

    @NotNull HeartbeatErrorPublisher errorPublisher;
    ...
    @NotNull Map<String, Object> consumerBatchProcessingConfig() {
        ...
        prop.put(JsonDeserializer.TRUSTED_PACKAGES, trustedPackages);
        return prop;
    }
