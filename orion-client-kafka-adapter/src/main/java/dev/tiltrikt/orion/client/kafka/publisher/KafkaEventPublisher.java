...
public class KafkaEventPublisher implements EventPublisher {
    ...
    public void publishRegistration(@NotNull InstanceRegistrationEvent event) {
        instanceRegistrationEventKafkaTemplate.send(KafkaTopicConfiguration.INSTANCE_REGISTRATION_TOPIC, event);
    }

    @Override
    public void publishDeregistration(@NotNull InstanceDeregistrationEvent event) {
        instanceDeregistrationEventKafkaTemplate.send(KafkaTopicConfiguration.INSTANCE_DEREGISTRATION_TOPIC, event);
    }

    @Override
    public void publishHeartbeat(@NotNull InstanceHeartbeatEvent event) {
        instanceHeartbeatEventKafkaTemplate.send(KafkaTopicConfiguration.INSTANCE_HEARTBEAT_TOPIC, event);
    }
